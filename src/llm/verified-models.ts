// Generated from pinned Python llm/utils/verified_models.py; run scripts/parity/generate-verified-models.py.
...
export const VERIFIED_DEEPSEEK_MODELS = [
  "deepseek-chat",
...
export const VERIFIED_MOONSHOT_MODELS = [
  "kimi-k3",
  "kimi-k2-thinking",
  "kimi-k2.7-code",
  "kimi-k2.6",
...
export const VERIFIED_GLM_MODELS = [
  "glm-4.7",
  "glm-4.7-flash",
  "glm-5",
  "glm-5.1",
...
export const VERIFIED_QWEN_MODELS = [
  "qwen3-6-plus",
  "qwen3.5-plus",
  "qwen3.6-plus",
  "qwen3.7-plus",
